...
// 主題
export const THEMES = [
  { key: "oat",    label: "奶茶", emoji: "🥛" },
  { key: "mint",   label: "薄荷", emoji: "🌿" },
  { key: "sakura", label: "櫻花", emoji: "🌸" },
  { key: "night",  label: "夜貓", emoji: "🌙" },
  { key: "deep",    label: "深海", emoji: "🌊" },
  { key: "carbon",  label: "碳黑", emoji: "⚡" },
  { key: "forest",  label: "森林", emoji: "🌲" },
  { key: "sunrise", label: "暖陽", emoji: "🌅" },
];
